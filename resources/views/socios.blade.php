...
@section('content')
  ...
  <header class="header">
    ...
    <div class="banner">
      ...
      <button class="btn btn1">Torna-te sócio</button>
      <button class="btn btn1">Pagar Quotas</button>
    </div>
  ...
  <div class="container-card">
    <div class="card">
      ...
      <div class="contenido-card">
        ...
        <button class="btn3 btn2">Aderir</button>
      </div>
    </div>

    <div class="card">
      <figure>
        <img src="resources/img/documents.png">
      </figure>
      <div class="contenido-card">
        <h3>Paga as quotas</h3>
        <p>Online, a qualquer hora, <span>rápido e 100% seguro,</span> aceda já!</p>
        <button class="btn3 btn2">Pagar</button>
      </div>
    </div>
  ...
  <div class="columns">
    <ul class="preco">
      ...
      <li>Item 1</li>
      <li>Item 1</li>
      <li class="grey"><button class="btn4 btn5">Aderir</button></li>
    </ul>
  </div>
